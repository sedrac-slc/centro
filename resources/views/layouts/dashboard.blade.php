...
@section('content')
    <nav class="navbar navbar-expand-lg mb-4 border-b-yellow menu-nav">
        <div class="container-fluid position-relative">
            <a class="navbar-brand" href="#">
                <span class="bg-yellow p-1 rounded">Smart</span>
                <span>Centro</span>
            </a>
            ...
            <a href="#" class="rounded btn-sm btn-del d-flex gap-1 align-items-center btn-logaut-my"
