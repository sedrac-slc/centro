...
@section('thead')
    <th>
        <div><i class="fas fa-signature"></i><span>Aluno</span></div>
    </th>
    <th>
        <div><i class="fas fa-chalkboard"></i><span>Curso(Nome)</span></div>
    </th>
    <th>
        <div><i class="fas fa-chalkboard"></i><span>Curso(Preco)</span></div>
    </th>
    <th>
    ...
    <th>
        <div><i class="fas fa-money-bill"></i><span>Valor(Entrego)</span></div>
    </th>
    <th>
        <div><i class="fas fa-bars"></i><span>Prestação</span></div>
    </th>
    <th>
        <div><i class="fas fa-list"></i><span>Troco</span></div>
    </th>
    <th colspan="2">
