<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="{{ route('utilizadores.index') }}"><i
                    class="fas text-yellow fa-user-tie"></i><span>Administradores</span></a></li>
        <li><a class="dropdown-item" href="{{ route('alunos.index') }}"><i
                    class="fas text-yellow fa-user-graduate"></i><span>Alunos</span></a></li>
        <li><a class="dropdown-item" href="{{ route('professores.index') }}"><i
                    class="fas text-yellow fa-chalkboard-teacher"></i><span>Professores</span></a></li>
    </ul>
</li>
<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
    ...
    <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="{{ route('cursos.index') }}"><i
                    class="fas text-yellow fa-chalkboard"></i><span>Curso</span></a></li>
        <li><a class="dropdown-item" href="{{ route('disciplinas.index') }}"><i
                    class="fas text-yellow fa-clipboard"></i><span>Disciplina</span></a></li>
        <li><a class="dropdown-item" href="{{ route('notas.index') }}"><i
                    class="fas text-yellow fa-clipboard-list"></i><span>Notas</span></a></li>
    </ul>
</li>
<li class="nav-item">
