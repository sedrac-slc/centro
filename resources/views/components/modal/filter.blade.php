<div class="modal fade m-2 p-1" id="modalFilter" tabindex="-1" aria-labelledby="modalFilterTitle" aria-hidden="true">
    <div class="modal-dialog">
      <form id="form-del" class="modal-content bg-white rounded" action="" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="modal-heade">
          <h5 class="modal-title" id="modalFilterTitle">{{$title}}</h5>
        </div>
